...
public:
  ...
  static Data readClipboard(UIPlugin *uiPlugin, const Parameters &params);
  static Data readFile(UIPlugin *uiPlugin, const QString &path, const Parameters &params);

  static const QMap<QString, Encoding> SUPPORTED_ENCODINGS;

private:
  static Data readStream(UIPlugin *uiPlugin,
